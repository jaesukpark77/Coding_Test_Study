# problem link : https://www.codetree.ai/missions/2/problems/clear-stones-well?&utm_source=clipboard&utm_medium=text
...
ans = 0
s_pos = []
stone_pos = [(i, j) for i in range(n) for j in range(n) if a[i][j] == 1]
selected_stones = []
