# problem link : https://www.codetree.ai/missions/2/problems/sequential-movement-of-stacked-numbers?&utm_source=clipboard&utm_medium=text
...
def next_pos(pos):
    ...
    x, y = pos
    mxx_val, max_pos = -1, OUT_OF_GRID
    for dx, dy in zip(dxs, dys):
        nx, ny = x + dx, y + dy
        if in_range(nx, ny):
            for num in grid[nx][ny]:
                if num > mxx_val:
                    mxx_val, max_pos = num, (nx, ny)
