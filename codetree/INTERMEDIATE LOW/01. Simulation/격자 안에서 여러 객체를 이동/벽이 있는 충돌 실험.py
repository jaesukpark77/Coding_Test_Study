# problem link : https://www.codetree.ai/missions/2/problems/collision-experiment-with-wall?&utm_source=clipboard&utm_medium=text
...
n, m = 0, 0
marbles = []
marble_cnt = [[0] * (MAX_N + 1) for _ in range(MAX_N + 1)]
